...
{-| The 404 page. Will display on any invalid route.
-}
    ...
    div [ class "w-full lg:w-3/5 border-l border-r border-gray-400 flex flex-col linedBg" ]
        [ div [ class "container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700" ]
            [ div [ class "pt-6 max-w-md" ]
                ...
                -- Link back to Chat screen
                , a [ href "/", class "px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-green bg-green-400 active:bg-green-400 hover:bg-green-600" ]
                    [ text "back to chat" ]
                ]
            ]
        ]
