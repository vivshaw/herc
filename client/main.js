...
var $author$project$ChatAPI$Object$Message$author = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'String', 'author', _List_Nil, $elm$json$Json$Decode$string);
var $author$project$ChatAPI$Object$Message$content = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'String', 'content', _List_Nil, $elm$json$Json$Decode$string);
...
var $author$project$Main$messageSelection = A3($dillonkearns$elm_graphql$Graphql$SelectionSet$map2, $author$project$Main$Message, $author$project$ChatAPI$Object$Message$content, $author$project$ChatAPI$Object$Message$author);
...
var $author$project$ChatAPI$Query$messages = function (object_) {
	return A4(
...
var $author$project$Main$query = $author$project$ChatAPI$Query$messages($author$project$Main$messageSelection);
...
var $author$project$Main$makeRequest = A2(
	...
	A2($dillonkearns$elm_graphql$Graphql$Http$queryRequest, 'http://127.0.0.1:3000/graphql', $author$project$Main$query));
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2($krisajenkins$remotedata$RemoteData$Loading, $author$project$Main$makeRequest);
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Generated Query')
							])),
						A2(
						$elm$html$Html$pre,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text(
								$dillonkearns$elm_graphql$Graphql$Document$serializeQuery($author$project$Main$query))
							]))
					])),
				A2(
				$elm$html$Html$div,
